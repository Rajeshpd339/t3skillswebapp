...
let Project=()=>{
  ...
  return(
    ...
    <h3><i className="fa-brands fa-python"></i>Python Project:</h3>
    <div className="ProjectName">
      <Link to="/project/PythonProject/BaseConversionApplication" target="_top">1. Base Conversion App</Link><br/>
      <Link to="/project/PythonProject/PrintWeekdayName" target="_top">2. Print Weekday Name</Link><br/>
